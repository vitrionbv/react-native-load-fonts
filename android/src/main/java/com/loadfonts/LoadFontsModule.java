...
@ReactModule(name = LoadFontsModule.NAME)
public class LoadFontsModule extends ReactContextBaseJavaModule {
  int tempNameCounter = 0;

  public static final String NAME = "LoadFonts";

  public LoadFontsModule(ReactApplicationContext reactContext) {
    super(reactContext);
  }
