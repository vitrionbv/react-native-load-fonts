...
export default function App() {
  ...
  const loadTestFont = (name: string, base64: string) => {
    loadFont(name, base64, 'ttf',true).then(function (name) {
  ...
  return (
    <View style={styles.container}>
      <Text style={{fontFamily: font || 'Arial', fontSize: 20, marginBottom: 10}}>Font test</Text>
      <Text><Text style={{fontWeight: 'bold'}}>Last loaded font:</Text> {font || 'Arial'}</Text>
